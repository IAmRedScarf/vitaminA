...
public class LowestCommonAncestorOfABinaryTree {
    ...
    class Solution {
        ...
        public TreeNode lowestCommonAncestor_20220502(TreeNode root, TreeNode p, TreeNode q) {
            ...
            TreeNode left = lowestCommonAncestor_20220502(root.left, p, q);
            TreeNode right = lowestCommonAncestor_20220502(root.right, p, q);
            if (left == null) {
                return right;
            }
            if (right == null) {
        ...
        public TreeNode lowestCommonAncestor_old(TreeNode root, TreeNode p, TreeNode q) {
            ...
            TreeNode left = lowestCommonAncestor_old(root.left, p, q);
            TreeNode right = lowestCommonAncestor_old(root.right, p, q);
            if (left == null) {
                return right;
            }
            if (right == null) {
