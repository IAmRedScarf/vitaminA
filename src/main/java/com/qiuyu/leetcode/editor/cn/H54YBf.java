...
//binary-tree/ 
// Related Topics 树 深度优先搜索 广度优先搜索 设计 字符串 二叉树 👍 55 👎 0
...
public class H54YBf {
    ...
    public class Codec {
        ...
        int start = 0;
        private TreeNode deserialize(String[] dataArray) {
            if (dataArray[start].equals("#")) {
                return null;
            }
            int rootVal = Integer.parseInt(dataArray[start]);
