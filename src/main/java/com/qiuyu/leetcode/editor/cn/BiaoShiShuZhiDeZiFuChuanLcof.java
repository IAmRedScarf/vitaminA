...
public class BiaoShiShuZhiDeZiFuChuanLcof {
    public static void main(String[] args) {
        ...
        System.out.println(solution.isNumber("+.2e1"));
    }
    ...
    class Solution {
        ...
        public boolean isNumber(String s) {
            ...
            boolean numeric = judgeNum(s);
            if (index < s.length() && s.charAt(index) == '.') {
                index++;
                numeric = judgeWithoutSign(s) || numeric;
            }
            if (index < s.length() && (s.charAt(index) == 'e' || s.charAt(index) == 'E')) {
                index++;
                numeric = numeric && judgeNum(s);
            }
            while (index < s.length() && s.charAt(index) == ' ') {
                index++;
            }
        ...
        private boolean judgeNum(String s) {
            ...
            return judgeWithoutSign(s);
        }

        private boolean judgeWithoutSign(String s) {
            int before = index;
